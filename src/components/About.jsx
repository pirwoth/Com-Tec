      ...
      >
        <div className="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
          ...
          <motion.div
            ...
            className="glass-effect card p-6 sm:p-12 rounded-3xl mb-10 sm:mb-20"
          >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 mt-6">
                {values.map((value, index) => (
                  <motion.div
                    ...
                    className="text-center p-4 sm:p-6 bg-white card rounded-2xl shadow-sm hover-lift"
                  >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8 mb-10 sm:mb-20 mt-8 sm:mt-14">
            {achievements.map((achievement, index) => (
              <motion.div
                ...
                className="glass-effect card p-6 sm:p-8 rounded-3xl hover-lift text-center group"
              >
          ...
          >
            ...
            <p className="text-xs sm:text-base text-slate-600 leading-loose mb-4 sm:mb-8 px-3 sm:px-4">
            ...
            <div className="space-y-4 sm:space-y-6">
              {[
                ...
                <div key={index} className="p-4 sm:p-6 bg-white rounded-2xl hover-lift border-l-4 border-navy-600 mx-auto max-w-md">
                  ...
                  <p className="text-xs sm:text-sm text-slate-600 mb-1 sm:mb-2 px-2 sm:px-3">{rep.description}</p>
