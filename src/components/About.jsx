      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-base sm:text-xl text-slate-600 max-w-2xl sm:max-w-4xl mx-auto leading-relaxed">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8 mb-10 sm:mb-20">
            {achievements.map((achievement, index) => (
              ...
              >
                ...
                <p className="text-xs sm:text-base text-slate-600 leading-relaxed mb-4 sm:mb-6">{achievement.description}</p>
          ...
          >
            ...
            <p className="text-base sm:text-lg text-slate-600 leading-relaxed max-w-2xl sm:max-w-4xl mx-auto">
