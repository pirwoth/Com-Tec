      ...
      >
        <div className="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-base sm:text-xl text-slate-600 max-w-2xl sm:max-w-4xl mx-auto leading-relaxed px-2">
          ...
          <motion.div
            ...
            className="glass-effect p-6 sm:p-12 rounded-3xl mb-10 sm:mb-20"
          >
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
              <div>
                ...
                <p className="text-base sm:text-lg text-slate-600 leading-relaxed mb-4 sm:mb-6 px-2">
              ...
              <div className="grid grid-cols-2 gap-4 sm:gap-6">
                {values.map((value, index) => (
                  <motion.div
                    ...
                    className="text-center p-4 sm:p-6 bg-white rounded-2xl shadow-sm hover-lift"
                  >
          ...
          {/* Achievements */}
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8 mb-10 sm:mb-20">
            {achievements.map((achievement, index) => (
              <motion.div
                ...
                className="glass-effect p-6 sm:p-8 rounded-3xl hover-lift text-center group"
              >
                ...
                <p className="text-xs sm:text-base text-slate-600 leading-relaxed mb-4 sm:mb-6 px-2">{achievement.description}</p>
          ...
          <motion.div
            ...
            className="glass-effect p-6 sm:p-12 rounded-3xl text-center mb-10 sm:mb-20"
          >
            <h3 className="text-2xl sm:text-3xl font-serif font-bold gradient-text mb-4 sm:mb-8">
              Our Company Goals
            </h3>
            <p className="text-base sm:text-lg text-slate-600 leading-relaxed max-w-2xl sm:max-w-4xl mx-auto px-2">
          ...
          <motion.div
            ...
            className="glass-effect p-4 sm:p-8 rounded-3xl text-center"
          >
            ...
            <p className="text-xs sm:text-base text-slate-600 leading-relaxed mb-4 sm:mb-8 px-2">
            ...
            <div className="space-y-4 sm:space-y-6">
              {[
                { name: 'N-T CON', description: 'Digital Hybrid IP PBX Systems', region: 'East African Region' },
                { name: 'HAROTEL', description: 'Wireless GSM Terminals & Communication Systems', region: 'East African Region' },
                { name: 'Cmaktech', description: 'Mobile Asset Tracking & Telematics Services', region: 'Country Representative' }
              ].map((rep, index) => (
                <div key={index} className="p-4 sm:p-6 bg-white rounded-2xl hover-lift border-l-4 border-navy-600 mx-auto max-w-md">
                  <h4 className="text-base sm:text-xl font-bold text-navy-600 mb-1 sm:mb-2 px-1">{rep.name}</h4>
                  <p className="text-xs sm:text-sm text-slate-600 mb-1 sm:mb-2 px-1">{rep.description}</p>
