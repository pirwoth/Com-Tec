    ...
    <section id="projects" className="section-padding bg-gradient-to-br from-white to-slate-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <AnimatePresence>
            {filteredProjects.map((project, index) => (
              <motion.div
                ...
                className="glass-effect p-6 rounded-2xl hover-lift group relative overflow-hidden"
              >
                {project.featured && (
                ...
                <div className="flex items-start space-x-3 mb-4">
                  ...
                  <div className="flex-1 min-w-0">
                    <h3 className="font-bold text-slate-800 group-hover:text-navy-600 transition-colors leading-tight">
                      {project.name}
                    </h3>
                  </div>
                </div>
                ...
                <div className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-medium ${getSolutionColor(project.solution)}`}>
        ...
        <motion.div
          ...
          className="grid grid-cols-2 lg:grid-cols-4 gap-8 mt-20 pt-16 border-t border-slate-200"
        >
          <div className="text-center">
            <div className="text-4xl font-bold text-navy-600 mb-2">38+</div>
            <div className="text-slate-600 font-medium">Major Projects</div>
          </div>
          <div className="text-center">
            <div className="text-4xl font-bold text-navy-600 mb-2">9</div>
            <div className="text-slate-600 font-medium">Industry Sectors</div>
          </div>
          <div className="text-center">
            <div className="text-4xl font-bold text-navy-600 mb-2">100%</div>
