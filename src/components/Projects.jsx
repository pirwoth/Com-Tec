...
const Projects = () => {
  ...
  const projects = [
    ...
    { id: 14, name: 'ACTION AID INT (country wide)', solution: 'TELEPHONE', category: 'NGO', featured: true },
    ...
    { id: 31, name: 'TAIBAH INT JUNIOR SCHOOL', solution: 'TELEPHONE & CCTV', category: 'Education', featured: false },
    { id: 32, name: 'TAIBAH INT COLLEGE SCHOOL', solution: 'TELEPHONE & CCTV', category: 'Education', featured: false },
